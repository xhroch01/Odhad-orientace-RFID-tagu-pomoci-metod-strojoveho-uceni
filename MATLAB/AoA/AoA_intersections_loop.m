...
% Cesta ke složce, kam se uloží csv
outputFolder = 'sem vložit cestu ke složce s výsledným CSV';
...
med_err = median(resultsTable.Error_mm);
avg_err = mean(resultsTable.Error_mm);

fprintf('\n Statistika lokalizace \n');
fprintf('   Zpracováno souborů: %d \n', height(resultsTable));
fprintf('   Průměrná chyba: %6.2f mm | Medián chyby: %6.2f mm \n\n', avg_err, med_err);


%% Konec + export

outputCsvFile = fullfile(outputFolder, 'Results_intersection_analysis.csv');
