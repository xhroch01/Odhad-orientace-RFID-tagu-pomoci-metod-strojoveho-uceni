...
testFile = 'sem vložit cestu ke složce s testovanými soubory';
...
hold on;
plot(estimated_angle, min_error, 'ro', 'MarkerFaceColor', 'r');
grid on;
title(sprintf('Chybová funkce (Minimum: %.1f°)', estimated_angle));
ylabel('Komplexní chyba');
xlabel('Úhel [°]')
