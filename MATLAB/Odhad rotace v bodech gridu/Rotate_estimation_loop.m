...
% Cesta, kam se uloží výstupní CSV
outputFolder = 'sem vložit cestu, kam se uloží výstupní csv';
...
outputCsvFile = fullfile(outputFolder, 'Results_rotation_estimation.csv');
