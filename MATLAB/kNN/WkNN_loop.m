...
load('RF_Model.mat', 'RFmodel'); % načtení RF modelu - nutno nastavit cestu

dataFolder = 'Sem nastavit cestu ke zpracovavaným souborům'; % Cesta ke zpracovávaným souborům
