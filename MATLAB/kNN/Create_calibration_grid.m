...
dataFolder = 'C:\Skola\Diplomka_RFID\ML\Priprava_odevzdani\kNN_priprava_odevzdani\Grid 200x200\lambda3'; % Nastavit cestu k datasetu tvořící referenční grid

% Získání seznamu všech .fld souborů
files = dir(fullfile(dataFolder, '*.fld'));
...
% Uložení databáze
save('RFID_square_Database_WKNN_lambda3.mat', 'Database');